...
const verifyToken = require('../middleware/verifyToken'); // For user context if needed
...
// Decide if `verifyToken` is always needed here.
...
// For simplicity, for these payment routes related to actual orders, I will NOT add verifyToken here.
...
router.post('/update-user-plan', verifyToken, paymentController.updateUserPlan);
