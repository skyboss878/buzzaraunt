...
exports.generatePromo = async (req, res) => {
  ...
  try {
    ...
    console.error('Error generating and saving promo:', err);
    res.status(500).json({ success: false, message: 'Server error generating promo.' });
  }
};
...
exports.getPromos = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: 'Server error fetching promos.' });
  }
};
...
exports.deletePromo = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: 'Server error deleting promo.' });
  }
};
