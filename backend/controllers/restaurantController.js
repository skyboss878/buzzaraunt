...
exports.createRestaurant = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: 'Server error creating restaurant.', error: err.message, error: err.message });
  }
};
...
exports.getRestaurant = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: "Server error.", error: err.message, error: err.message, error: err.message });
        console.error("❌ Error:", err);
    res.status(500).json({ success: false, message: 'Server error fetching restaurant.', error: err.message, error: err.message });
  }
};
...
exports.updateRestaurant = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: "Server error.", error: err.message, error: err.message, error: err.message });
        ...
        console.error("❌ Error:", err);
    res.status(500).json({ success: false, message: 'Server error updating restaurant.', error: err.message, error: err.message });
  }
};
